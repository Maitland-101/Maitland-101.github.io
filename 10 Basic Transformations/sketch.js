...
function draw() {
  ...
  // translate(120,120); //move cooridinate system
  // drawBasicGrid(150);
  // rectangleRed(0,0);
  ...
  //scale: 1->nochange <1->smaller >1->larger
  // let scaleAmount = 2.5;
  // scale(scaleAmount,1);
  // translate(60,60);
  // drawBasicGrid(100);
  ...
  // push();
  // //to rotate an object around itslef
  // //1. translate to objects postion
  // //2. apply tjr rotation transformation
  ...
  let spoke = map(mouseX,0,width,1,250);
